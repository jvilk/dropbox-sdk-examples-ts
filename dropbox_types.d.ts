declare module DropboxTypes {
  ...
  namespace async {
     ...
     * :type:`PollEmptyResult` for an example.
     */
  ...
  namespace auth {
     ...
     */
    type AuthError = AuthErrorInvalidAccessToken | AuthErrorInvalidSelectUser | AuthErrorInvalidSelectAdmin | AuthErrorOther;
  ...
  namespace files {
    ...
    interface FileMetadata extends Metadata {
       ...
       * is true in :route:`list_folder` or :route:`get_metadata`. If this  flag
    ...
    interface Metadata {
       ...
       * behavior will match the path provided in the Core API v1. Changes to
       * the casing of paths won't be returned by :route:`list_folder/continue`.
  ...
  namespace sharing {
    ...
    interface CreateSharedLinkArg {
       ...
       * either :field:`PendingUploadMode.file` or
    ...
    interface GetMetadataArgs {
       ...
       * a boolean value  :field:`FolderPermission.allow` that describes whether
    ...
    interface LinkPermissions {
       ...
       * considering these policies, can be found in
    ...
    interface ListFolderMembersContinueArg {
      /**
       * The cursor returned by your last call to :route:`list_folder_members`
       * or :route:`list_folder_members/continue`.
       */
      cursor: string;
    }
    ...
    interface ListFolderMembersCursorArg {
       ...
       * boolean value :field:`MemberPermission.allow` that describes whether
     ...
     * depending on which endpoint was requested. Unmounted shared folders can
     * be identified by the absence of :field:`SharedFolderMetadata.path_lower`.
     */
    ...
    type SharePathError = SharePathErrorIsFile | SharePathErrorInsideSharedFolder | SharePathErrorContainsSharedFolder | SharePathErrorIsAppFolder | SharePathErrorInsideAppFolder | SharePathErrorIsPublicFolder | SharePathErrorInsidePublicFolder | SharePathErrorAlreadyShared | SharePathErrorInvalidPath | SharePathErrorIsOsxPackage | SharePathErrorInsideOsxPackage | SharePathErrorOther;
    ...
    interface SharedFileMembers {
       ...
       * returned yet. Pass the cursor into :route:`list_file_members/continue`
    ...
    type SharedLinkError = SharedLinkErrorSharedLinkNotFound | SharedLinkErrorSharedLinkAccessDenied | SharedLinkErrorOther;
    ...
    type UnshareFolderError = UnshareFolderErrorAccessError | UnshareFolderErrorTeamFolder | UnshareFolderErrorNoPermission | UnshareFolderErrorOther;
  ...
  namespace team {
    ...
    /**
     * Error that can be raised when :type:`GroupMemberSelector` is used, and
    ...
    /**
     * Error that can be raised when :type:`GroupMembersSelector` is used, and
    ...
    type GroupUpdateError = GroupSelectorError | GroupUpdateErrorExternalIdAlreadyInUse;
    ...
    interface ListMembersAppsArg {
       ...
       * includes a cursor, the following requests should include the received
    ...
    /**
     * Indicates that the cursor has been invalidated. Call
     * :route:`linked_apps/list_members_linked_apps` again with an empty cursor
     * to obtain a new cursor.
     */
    ...
    interface ListMembersDevicesArg {
      /**
       * At the first call to the :route:`devices/list_members_devices` the
    ...
    /**
     * Indicates that the cursor has been invalidated. Call
     * :route:`devices/list_members_devices` again with an empty cursor to
     * obtain a new cursor.
     */
    ...
    interface ListMembersDevicesResult {
      ...
      has_more: boolean;
      /**
       * Pass the cursor into :route:`devices/list_members_devices` to receive
     ...
     * the parameter of :route:`members/get_info`.
     */
    ...
    interface MembersListResult {
       ...
       * returned yet. An additional call to :route:`members/list/continue` can
       * retrieve them.
       */
      has_more: boolean;
    }
    ...
    type MembersRecoverError = UserSelectorError | MembersRecoverErrorUserUnrecoverable | MembersRecoverErrorUserNotInTeam | MembersRecoverErrorOther;
